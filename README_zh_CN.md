...
一个强大的思源笔记 PDF 标注摘录工具，帮助你高效地从 PDF 文档中提取知识并组织成结构化笔记。
...
### v0.0.18
- 修复：标注高亮框垂直偏移问题（统一使用 `viewport.height` 作为坐标参考）
- 优化：翻页按钮不再干扰 PDF 拖动操作（需悬停延迟才能激活）
- 优化：页码指示器移至右下角，不再遮挡 PDF 内容
- 优化：缩小翻页区域并增加悬停延迟，防止摘录时误触翻页
