  ...
  <div class="annotation-style-selector">
    ...
    <div class="style-section">
      ...
      <div class="type-buttons">
        <button
          ...
          :key="type.value"
          class="type-btn"
          :class="[{ active: modelValue.type === type.value }]"
    ...
    <div class="style-section">
      ...
      <div class="color-picker">
        <button
          ...
          :key="color.hex"
          class="color-btn"
          :class="[{ active: modelValue.color === color.hex }]"
          :style="{ backgroundColor: color.hex }"
          :title="color.label"
          @click="selectColor(color.hex)"
        >
          <span
            v-if="modelValue.color === color.hex"
            class="check-icon"
          >✓</span>
        </button>
        <input
    ...
    >
      ...
      <div
        ...
        :style="{
          backgroundColor: modelValue.color, opacity: modelValue.opacity,
        }"
      >
        预览效果
      </div>
  ...
  const types = [
    {
      ...
      label: ANNOTATION_TYPE_CONFIG.highlight.label,
      icon: ANNOTATION_TYPE_CONFIG.highlight.icon,
      description: ANNOTATION_TYPE_CONFIG.highlight.description,
    },
    {
      value: AnnotationType.UNDERLINE,
      label: ANNOTATION_TYPE_CONFIG.underline.label,
      icon: ANNOTATION_TYPE_CONFIG.underline.icon,
      description: ANNOTATION_TYPE_CONFIG.underline.description,
    },
    {
      value: AnnotationType.STRIKETHROUGH,
      label: ANNOTATION_TYPE_CONFIG.strikethrough.label,
      icon: ANNOTATION_TYPE_CONFIG.strikethrough.icon,
      description: ANNOTATION_TYPE_CONFIG.strikethrough.description,
    },
    {
      value: AnnotationType.SQUIGGLY,
      label: ANNOTATION_TYPE_CONFIG.squiggly.label,
      icon: ANNOTATION_TYPE_CONFIG.squiggly.icon,
      description: ANNOTATION_TYPE_CONFIG.squiggly.description,
    },
  ]
    ...
    types.push(
      {
        ...
        label: ANNOTATION_TYPE_CONFIG.rectangle.label,
        icon: ANNOTATION_TYPE_CONFIG.rectangle.icon,
        description: ANNOTATION_TYPE_CONFIG.rectangle.description,
      },
      {
        value: AnnotationType.CIRCLE,
        label: ANNOTATION_TYPE_CONFIG.circle.label,
        icon: ANNOTATION_TYPE_CONFIG.circle.icon,
        description: ANNOTATION_TYPE_CONFIG.circle.description,
      },
      {
        value: AnnotationType.FREEHAND,
        label: ANNOTATION_TYPE_CONFIG.freehand.label,
        icon: ANNOTATION_TYPE_CONFIG.freehand.icon,
        description: ANNOTATION_TYPE_CONFIG.freehand.description,
      },
      {
        value: AnnotationType.NOTE,
        label: ANNOTATION_TYPE_CONFIG.note.label,
        icon: ANNOTATION_TYPE_CONFIG.note.icon,
        description: ANNOTATION_TYPE_CONFIG.note.description,
      },
      {
        value: AnnotationType.TEXT,
        label: ANNOTATION_TYPE_CONFIG.text.label,
        icon: ANNOTATION_TYPE_CONFIG.text.icon,
        description: ANNOTATION_TYPE_CONFIG.text.description,
      },
    )
  }
