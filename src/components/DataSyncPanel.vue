  ...
  <div class="data-sync-panel">
      ...
      <div class="backup-section">
        ...
        <div class="backup-options">
          <label class="checkbox-label">
            <input
              v-model="backupOptions.includeStudySets"
              type="checkbox"
            />
            <span>学习集</span>
          </label>
          <label class="checkbox-label">
            <input
              v-model="backupOptions.includeCards"
              type="checkbox"
            />
            <span>卡片</span>
          </label>
          <label class="checkbox-label">
            <input
              v-model="backupOptions.includeMindMaps"
              type="checkbox"
            />
            <span>思维导图</span>
          </label>
          <label class="checkbox-label">
            <input
              v-model="backupOptions.includeReviews"
              type="checkbox"
            />
            <span>复习记录</span>
          </label>
    ...
    >
      ...
      <div class="restore-section">
        ...
        <div class="version-options">
          <select
            v-model="versionOptions.dataType"
            class="sy-select"
          >
            <option value="studySet">
              学习集
            </option>
            <option value="card">
              卡片
    ...
    >
      <div class="cloud-section">
        ...
        <div
          v-if="cloudConfig.provider === 'webdav'"
          class="webdav-settings"
        >
          <div class="form-group">
            <label>WebDAV 地址</label>
            <input
              v-model="cloudConfig.webdavUrl"
              type="url"
              placeholder="https://..."
              class="sy-input"
            />
          ...
          <div class="form-group">
            <label>用户名</label>
            <input
              v-model="cloudConfig.webdavUsername"
              type="text"
              class="sy-input"
            />
          </div>
          <div class="form-group">
            <label>密码</label>
            <input
              v-model="cloudConfig.webdavPassword"
              type="password"
              class="sy-input"
            />
          </div>
        ...
        <div class="form-group">
          <label>同步间隔（分钟）</label>
          <input
            v-model.number="cloudConfig.syncInterval"
            type="number"
            class="sy-input"
          />
        </div>
        ...
        <div class="export-options">
          ...
          <div class="form-group">
            ...
            >
              ...
              <option value="studySets">
                学习集
              </option>
              <option value="mindmaps">
                思维导图
              </option>
            </select>
          </div>
