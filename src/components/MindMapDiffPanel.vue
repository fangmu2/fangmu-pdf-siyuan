...
<template>
  <div class="mindmap-diff-panel">
    ...
    <div class="filter-tabs">
      ...
      <button
        :class="['filter-tab', 'added', { active: activeFilter === 'added' }]"
      ...
      <button
        :class="['filter-tab', 'removed', { active: activeFilter === 'removed' }]"
      ...
      <button
        :class="['filter-tab', 'modified', { active: activeFilter === 'modified' }]"
      ...
      <button
        :class="['filter-tab', 'moved', { active: activeFilter === 'moved' }]"
    ...
    <div class="diff-list">
      ...
      >
        ...
        <div class="item-content">
          <div class="item-title">{{ getNodeText(item.node) }}</div>
      ...
      >
        ...
        <div class="item-content">
          <div class="item-title deleted">{{ getNodeText(item.node) }}</div>
          <div class="item-path">{{ item.path.join(' > ') }}</div>
        </div>
      ...
      >
        ...
        <div class="item-content">
          <div class="item-title">{{ getNodeText(item.newNode) }}</div>
          <div class="item-path">{{ item.path.join(' > ') }}</div>
          <div class="item-changes">
            <span v-for="change in item.changes" :key="change" class="change-tag">
              {{ change }}
            </span>
          </div>
          <div v-if="showDetails" class="item-diff">
            <div class="diff-old">
...
import type { VersionDiff, MindMapVersion } from '../services/mindmapVersionService';
