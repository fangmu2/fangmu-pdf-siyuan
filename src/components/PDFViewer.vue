  ...
  >
    ...
    <div class="pdf-content-wrapper">
      ...
      >
        <div
          class="page-nav-btn"
          :class="{ visible: showRightNav }"
          @click="handlePageNavClick('next')"
        >
          <svg
            viewBox="0 0 24 24"
            width="20"
      ...
      <div class="toolbar-section toolbar-left">
        <div class="annotation-type-selector">
          <button
            ...
            :key="type.value"
            class="type-btn"
            :class="[{ active: selectedAnnotationType === type.value }]"
            :title="type.label"
        ...
        <div class="shape-tools">
          <button
            class="shape-btn"
            :class="[{ active: shapeTool === 'rectangle' }]"
            title="矩形标注"
      ...
      >
        <div class="shape-color-picker">
          <button
            ...
            :key="color.value"
            class="color-btn"
            :class="[{ active: selectedShapeColor === color.value }]"
      ...
      <div class="toolbar-section toolbar-center">
        <div class="highlight-color-picker">
          <button
            ...
            :key="color.value"
            class="color-btn"
            :class="[{ active: selectedHighlightColor === color.value }]"
            :style="{ backgroundColor: color.hex }"
            :title="color.name"
...
const LEVEL_COLORS: Record<string, { bg: string, border: string }> = {
  ...
  h3: {
    bg: 'rgba(29, 209, 161, 0.35)',
    border: '#1dd1a1',
  },
  h4: {
    bg: 'rgba(72, 219, 251, 0.35)',
    border: '#48dbfb',
  },
  h5: {
    bg: 'rgba(84, 160, 255, 0.35)',
    border: '#54a0ff',
  },
  text: {
