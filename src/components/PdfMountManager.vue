  ...
  <div class="pdf-mount-manager">
    ...
    <div class="pdf-list">
      ...
      <div
        ...
        :key="pdf.id"
        class="pdf-item"
        :class="[{ active: currentPdfId === pdf.id }]"
      ...
      >
        ...
        <div class="pdf-item-actions">
          ...
          <button
            ...
            title="移除"
            @click.stop="handleRemovePdf(pdf)"
          >
            <svg
              viewBox="0 0 24 24"
              width="16"
    ...
    <div
      v-if="showPdfPicker"
      class="dialog-overlay"
      @click="showPdfPicker = false"
    >
      <div
        class="dialog pdf-picker-dialog"
        @click.stop
      >
        <div class="dialog-header">
          <h3>选择 PDF 文档</h3>
        ...
        <div class="dialog-body">
          <div class="pdf-picker-list">
            <div
              ...
              :key="file.path"
              class="pdf-picker-item"
              :class="[{ selected: formData.path === file.path }]"
            ...
            >
              ...
              <div class="pdf-picker-name">
                {{ file.name }}
              </div>
              <div class="pdf-picker-path">
                {{ file.path }}
              </div>
            </div>
          </div>
