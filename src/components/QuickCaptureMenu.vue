...
<template>
  <div
    v-if="visible"
    class="quick-capture-menu"
    :style="positionStyle"
    @click.stop
  >
    <!-- 触发按钮 -->
    <button
      class="quick-capture-menu__trigger"
      @click="toggleMenu"
    >
      <svg
        viewBox="0 0 24 24"
    ...
    <transition name="slide-fade">
      <div
        v-if="menuOpen"
        class="quick-capture-menu__panel"
      >
        <!-- 快捷操作 -->
        ...
        <div class="card-type-selector">
          ...
          <div class="type-options">
            <button
              class="type-option"
              :class="[{ active: selectedCardType === 'normal' }]"
            ...
            <button
              class="type-option"
              :class="[{ active: selectedCardType === 'flashcard' }]"
            ...
            <button
              class="type-option"
              :class="[{ active: selectedCardType === 'excerpt' }]"
