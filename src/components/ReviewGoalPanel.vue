...
<template>
  <div class="review-goal-panel">
    <div class="review-goal-panel__header">
      <h3 class="review-goal-panel__title">
        🎯 复习目标
      </h3>
      <button
        class="settings-btn"
        ...
        <div class="progress-stats">
          <div class="stat-item">
            <div
              ...
              :class="{ 'stat-item__value--highlight': todayCount >= dailyGoal }"
            >
              {{ todayCount }}
            </div>
    ...
    <div class="weekly-stats">
      <h4 class="weekly-stats__title">
        本周统计
      </h4>
      <div class="weekly-stats__grid">
        <div class="weekly-stat-card">
          <div class="weekly-stat-card__value">
            {{ weeklyStats.totalReviewed }}
          </div>
          <div class="weekly-stat-card__label">
            复习总数
          </div>
        </div>
        <div class="weekly-stat-card">
          <div class="weekly-stat-card__value">
            {{ weeklyStats.newLearned }}
          </div>
          <div class="weekly-stat-card__label">
            新学卡片
          </div>
    ...
    <div class="achievements-section">
      <h4 class="achievements-section__title">
        🏆 成就徽章
      </h4>
      <div class="achievements-grid">
        ...
        >
          ...
          <div
            ...
            class="achievement-card__progress"
          >
