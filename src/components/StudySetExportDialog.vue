          ...
          <div class="export-section">
            ...
            <div class="form-group">
              <label class="checkbox-label">
                <input type="checkbox" v-model="exportOptions.includeReviews" />
                <span>包含复习记录</span>
              </label>
            </div>
            ...
            <div class="export-preview" v-if="exportPreview">
              ...
              <div class="preview-item" v-if="exportOptions.includeReviews">
          ...
          <div class="import-section">
            ...
            <div class="file-dropzone"
              ...
              <template v-if="!selectedFile">
                <div class="dropzone-content">
                  <svg viewBox="0 0 24 24" width="48" height="48" fill="currentColor" class="dropzone-icon">
                    <path d="M19.35 10.04C18.67 6.59 15.64 4 12 4 9.11 4 6.6 5.64 5.35 8.04 2.34 8.36 0 10.91 0 14c0 3.31 2.69 6 6 6h13c2.76 0 5-2.24 5-5 0-2.64-2.05-4.78-4.65-4.96zM14 13v4h-4v-4H7l5-5 5 5h-3z"/>
                  </svg>
                  <p class="dropzone-text">拖拽文件到此处，或点击选择文件</p>
                  <p class="dropzone-hint">支持 .json 格式的导出文件</p>
                </div>
              </template>

              <template v-else>
                <div class="file-selected-content">
                  <svg viewBox="0 0 24 24" width="48" height="48" fill="currentColor" class="file-icon">
                    <path d="M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z"/>
                  </svg>
                  <p class="file-name">{{ selectedFile.name }}</p>
                  <p class="file-size">{{ formatFileSize(selectedFile.size) }}</p>
                  <button @click.stop="clearFile" class="clear-file-btn">清除</button>
                </div>
              </template>
            </div>
            ...
            <div class="import-preview" v-if="importPreview">
              ...
              <div class="import-options">
                <label class="checkbox-label">
                  <input type="checkbox" v-model="importOptions.importReviews" />
                  <span>导入复习记录</span>
                </label>
                <label class="checkbox-label">
                  <input type="checkbox" v-model="importOptions.renameIfConflict" />
