    ...
    rootNodes: [
      {
        ...
        content: '中心主题',
        children: [
          { id: 'c1', content: '第一章', children: [
            { id: 'c1-1', content: '第一节' },
            { id: 'c1-2', content: '第二节' }
          ]},
          { id: 'c2', content: '第二章', children: [
            { id: 'c2-1', content: '第一节' },
            { id: 'c2-2', content: '第二节' }
          ]},
          { id: 'c3', content: '第三章' }
    ...
    rootNodes: [
      {
        ...
        content: '事件时间线',
        children: [
          { id: 't1', content: '阶段一', children: [
            { id: 't1-1', content: '事件 1', note: '时间：YYYY-MM-DD' },
            { id: 't1-2', content: '事件 2', note: '时间：YYYY-MM-DD' }
          ]},
          { id: 't2', content: '阶段二', children: [
            { id: 't2-1', content: '事件 3', note: '时间：YYYY-MM-DD' },
            { id: 't2-2', content: '事件 4', note: '时间：YYYY-MM-DD' }
          ]}
        ]
      }
    ],
    ...
    rootNodes: [
      {
        ...
        content: '问题/结果',
        children: [
          { id: 'f1', content: '人员因素', children: [
            { id: 'f1-1', content: '原因 1' },
            { id: 'f1-2', content: '原因 2' }
          ]},
          { id: 'f2', content: '设备因素', children: [
            { id: 'f2-1', content: '原因 1' },
            { id: 'f2-2', content: '原因 2' }
          ]},
          { id: 'f3', content: '材料因素', children: [
            { id: 'f3-1', content: '原因 1' },
            { id: 'f3-2', content: '原因 2' }
          ]},
          { id: 'f4', content: '方法因素', children: [
            { id: 'f4-1', content: '原因 1' },
            { id: 'f4-2', content: '原因 2' }
          ]}
        ]
      }
    ],
    ...
    rootNodes: [
      {
        ...
        content: '核心概念',
        children: [
          { id: 'c1', content: '相关概念 A', children: [
            { id: 'c1-1', content: '子概念 A1' },
            { id: 'c1-2', content: '子概念 A2' }
          ]},
          { id: 'c2', content: '相关概念 B', children: [
            { id: 'c2-1', content: '子概念 B1' },
            { id: 'c2-2', content: '子概念 B2' }
          ]}
        ]
      }
    ],
    ...
    rootNodes: [
      {
        ...
        content: '组织名称',
        children: [
          { id: 'd1', content: '部门 A', children: [
            { id: 'd1-1', content: '小组 A1' },
            { id: 'd1-2', content: '小组 A2' }
          ]},
          { id: 'd2', content: '部门 B', children: [
            { id: 'd2-1', content: '小组 B1' },
            { id: 'd2-2', content: '小组 B2' }
          ]},
          { id: 'd3', content: '部门 C' }
        ]
      }
    ...
    rootNodes: [
      {
        ...
        content: '循环主题',
        children: [
          { id: 's1', content: '步骤 1', children: [
            { id: 's1-1', content: '说明' }
          ]},
          { id: 's2', content: '步骤 2', children: [
            { id: 's2-1', content: '说明' }
          ]},
          { id: 's3', content: '步骤 3', children: [
            { id: 's3-1', content: '说明' }
          ]},
          { id: 's4', content: '步骤 4', children: [
            { id: 's4-1', content: '说明' }
          ]}
        ]
      }
