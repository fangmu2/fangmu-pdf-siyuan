...
import type { PDFAnnotation, AnnotationType } from '../types/annotation';
...
const COLOR_CONFIGS: Record<string, { bg: string; border: string; line: string }> = {
  red: { bg: 'rgba(255, 107, 107, 0.35)', border: '#ff6b6b', line: '#ef4444' },
  yellow: { bg: 'rgba(255, 217, 61, 0.35)', border: '#ffd93d', line: '#eab308' },
  green: { bg: 'rgba(107, 203, 119, 0.35)', border: '#6bcb77', line: '#22c55e' },
  blue: { bg: 'rgba(77, 150, 255, 0.35)', border: '#4d96ff', line: '#3b82f6' },
  purple: { bg: 'rgba(155, 89, 182, 0.35)', border: '#9b59b6', line: '#a855f7' },
  orange: { bg: 'rgba(254, 202, 87, 0.35)', border: '#feca57', line: '#f97316' },
};
