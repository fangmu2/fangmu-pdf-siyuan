...
export const PRESET_RULES: Array<{
...
}> = [
  {
    ...
    icon: '📅',
    conditions: [
      { field: 'nextReview', operator: 'lessThanOrEq', value: Date.now() },
  ...
  },
  {
    ...
    icon: '⚠️',
    conditions: [
      { field: 'nextReview', operator: 'lessThan', value: Date.now() - 86400000 },
      { field: 'status', operator: 'notEquals', value: 'completed' }
    ]
  },
  {
    ...
    conditions: [
      ...
      { field: 'createdAt', operator: 'greaterThan', value: Date.now() - 7 * 86400000 }
    ]
  },
  {
    id: 'difficult',
    ...
    icon: '🔥',
    conditions: [
      { field: 'difficulty', operator: 'greaterThanOrEq', value: 4 }
    ]
  },
  {
    id: 'flashcards',
    ...
    icon: '🎴',
    conditions: [
      { field: 'type', operator: 'equals', value: 'flashcard' }
    ]
  },
  {
    id: 'no-tags',
    ...
    icon: '📋',
    conditions: [
      { field: 'tags', operator: 'isEmpty', value: true }
    ]
  },
  {
    id: 'learning',
    ...
    icon: '📖',
    conditions: [
      { field: 'status', operator: 'equals', value: 'learning' }
    ]
  },
  {
    id: 'completed-today',
    ...
    conditions: [
      ...
      { field: 'updatedAt', operator: 'greaterThan', value: new Date().setHours(0, 0, 0, 0) }
    ]
  }
];
