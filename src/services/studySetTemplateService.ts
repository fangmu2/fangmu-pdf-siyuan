...
const BUILTIN_TEMPLATES: StudySetTemplate[] = [
  {
    ...
    mindMapNodes: [
      ...
      },
      {
        ...
        text: '第二章',
        parentId: 'root',
        style: { backgroundColor: '#fbbc05', color: '#fff' }
      },
      {
        id: 'chapter-3',
        text: '第三章',
      ...
      },
      {
        ...
        text: '错题本',
        parentId: 'root',
        style: { backgroundColor: '#ea4335', color: '#fff', icon: '⚠️' }
      }
    ],
    reviewSettings: {
      newCardsPerDay: 20,
  ...
  },
  {
    ...
    mindMapNodes: [
      ...
      },
      {
        ...
        text: '待解决问题',
        parentId: 'root',
        style: { backgroundColor: '#fbbc05', color: '#fff', icon: '❓' }
      }
    ],
    reviewSettings: {
      newCardsPerDay: 10,
  ...
  },
  {
    ...
    mindMapNodes: [
      ...
      },
      {
        ...
        text: '练习任务',
        parentId: 'root',
        style: { backgroundColor: '#ea4335', color: '#fff', icon: '✅' }
      },
      {
        id: 'resources',
        text: '学习资源',
  ...
  },
  {
    ...
    mindMapNodes: [
      ...
      },
      {
        ...
        text: '研究问题',
        parentId: 'root',
        style: { backgroundColor: '#9c27b0', color: '#fff', icon: '❓' }
      },
      {
        id: 'hypothesis',
        text: '研究假设',
